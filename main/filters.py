...
class ProductFilter(django_filters.FilterSet):
    ...
    name = django_filters.CharFilter(label='Название',field_name='name', lookup_expr='icontains', widget=TextInput(attrs={'placeholder': 'Поиск по названию','size':'40'}))
    ...
    start_price = django_filters.NumberFilter(label='Цена от', field_name='price', lookup_expr='gte', widget=TextInput(attrs={'id': 'min_price', 'name': 'min_price'}))
    end_price = django_filters.NumberFilter(label='Цена до', field_name='price', lookup_expr='lte', widget=TextInput(attrs={'id': 'max_price', 'name': 'max_price'}))
